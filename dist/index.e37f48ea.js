...
const controlGetPicture = async function() {
    try {
        await _modelJs.loadPicture();
        (0, _viewJsDefault.default).renderPicture(_modelJs.state.picture);
    } catch (err) {
        console.error(err);
    }
};
...
const init = function() {
    (0, _viewJsDefault.default).addHandlerLoad(controlGetPicture);
    (0, _viewJsDefault.default).addHandlerRegenerate(controlRegenerateImage);
};
init();
...
parcelHelpers.export(exports, "loadPicture", ()=>loadPicture);
...
const API_URL = "https://shibe.online/api/shibes?httpsUrls=true";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["d8XZh","aenu9"], "aenu9", "parcelRequire98cc")
